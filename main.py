...
c1.image("4.jpg")
c3.image("3.jpg")
c2.subheader('"This Data is Retreived from a snowflake database it has covid data related to more that 230 countries"')
...
selected_country = st.selectbox('Select a country', countries,index=227)
